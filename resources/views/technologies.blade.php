        ...
        <form id="search-form" onsubmit="return false;">
            <div class="w-100 justify-content-end d-flex">
                ...
                <div class="card-body row no-gutters align-items-center h-4rem">
                    ...
                    <div class="col">
                        <input name="search" class="form-control-borderless p-3 fs-4 z-50  rounded-3 overflow-hidden fs-5 shadow-sm" id="search" type="search" placeholder="Zadejte hledaný výraz">
                    ...
                    <div class="col-auto searchButtonDiv">
                        ...
                        <span data-title="Najít" onclick="searchTechnology('search-form')">
                ...
                @foreach($statistics_types as $stat)
                    <div class="d-inline-flex bg-white rounded-3 m-2 p-3 flex-lg-grow-1 shadow-sm">
                        ...
                        <div class=" w-75 form-check form-switch d-grid text-center justify-content-center p-0 pt-2">
                            <input style="transform: scale(1.2)" class="form-check-input m-0 p-0 ms-1" checked type="checkbox" role="switch" name="{{$stat->code_name}}" id="flexSwitchCheckDefault">
                    ...
                    <div class="w-100 p-2 mt-3 d-flex flex-wrap justify-content-center justify-content-md-between">
                        ...
                        <div class="d-inline-flex bg-white rounded-3 m-2 p-3 flex-lg-grow-1 shadow-sm">
                            <div class=" text-center justify-content-center w-25">
                                ...
                                <select class="form-select w-100" aria-label="Default select example">
                                    <option selected value="-">Netříděno</option>
                                    <option selected value="-1">Sestupně</option>
                                    <option selected value="1">Vzestupně</option>

                                </select>
                            </div>
                            <div class="inline-flex w-75 p-4 ps-5">
                                @php
                                    $max_price = -1;
                                ...
                                <input class="range w-70 animate-05" type="range" min="0" max="{{$max_price}}" value="{{$max_price}}" oninput="this.parentNode.getElementsByClassName('number')[0].value = this.value">
                                <input type="number" min="0" max="{{$max_price}}" class="number fs-3 fw-bold bg-transparent border-none w-3rem" value="{{$max_price}}" onchange="this.parentNode.getElementsByClassName('range')[0].value = this.value">
                            </div>
                        </div>
                    ...
                    <div class="w-100 p-2 mt-1 d-flex flex-wrap justify-content-center justify-content-md-between">
                        ...
                        <div class="d-inline-flex bg-white rounded-3 m-2 p-4 flex-lg-grow-1 shadow-sm">
                            ...
                            <div class=" d-grid w-75 form-check form-switch  text-center justify-content-center p-0 ">
                                ...
                                <label class="form-check-label mt-1 fw-bold fs-5"  for="flexSwitchCheckDefault">Někým rozpracované</label>
                            </div>
                        </div>
                        ...
                        <div class="d-inline-flex bg-white rounded-3 m-2 p-4 flex-lg-grow-1 shadow-sm">
                            ...
                            <div class="d-grid w-75 form-check form-switch  text-center justify-content-center p-0 ">
                                <input style="transform: scale(1.2)" class="form-check-input m-0 p-0 ms-1" checked type="checkbox" role="switch" id="flexSwitchCheckDefault">
                                <label class="form-check-label mt-1 fw-bold fs-5"  for="flexSwitchCheckDefault">Někým patentované</label>
                            </div>
                        </div>
                        ...
                        <div class="d-inline-flex bg-white rounded-3 m-2 p-4 flex-lg-grow-1 shadow-sm">
                            <div class="d-grid w-75 form-check form-switch  text-center justify-content-center p-0">
                                <input style="transform: scale(1.2)" class="form-check-input m-0 p-0 ms-1" checked type="checkbox" role="switch" id="flexSwitchCheckDefault">
                                <label class="form-check-label mt-1 fw-bold fs-5" for="flexSwitchCheckDefault">Rozdělovat podle kol</label>
                            </div>
                        </div>
