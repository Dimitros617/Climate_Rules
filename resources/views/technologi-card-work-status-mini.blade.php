<div class="d-grid text-center p-3 m-2 bg-light rounded-3 animate-05 hover-size-01 hover-shadow cursor-pointer z-0 h-content"
     data-toggle="tooltip" data-placement="bottom" title="{{__('states_in_progress')}}."
     onclick="showAndHideElement(this.parentNode.parentNode.parentNode,'nation-work-status')">
                    ...
                    @endif
                        ...
                        <span class="technology-work-status fw-bold fs-5" hidden>
    {{--                    Počet států, které mají technologii nakoupenou, v mini toto číslo musí být taky kvuly filtrování--}}
