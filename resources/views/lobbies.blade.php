...
{{--Context menu--}}
    ...
    <div id="contextMenu" class="context-menu" style="display: none">
        <ul class="menu">
            ...
            <li class="show cursor-pointer">
                <a onclick="changeElement(window.last_context_element.getAttribute('table'), 'visible', window.last_context_element.getAttribute('element_id'), ((parseInt(window.last_context_element.getAttribute('visible')) + 1) % 2), 'refreshLobbyList')">
                    ...
                    <span id="context-menu-show" hidden>  </span>
                    {{ __('hide')}}
                </a>
            </li>

            <li class="trash cursor-pointer">
                <a onclick="removeLobby(window.last_context_element.getAttribute('element_id'))">
