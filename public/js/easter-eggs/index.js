...
function dog () {
    ...
    let dog = function () {
        ...
        img.style.bottom = 'calc(-50% + 430px)'
        img.style.zIndex = 999999
...
function bird () {
    ...
    let bird = function () {
        ...
        img.style.position = 'fixed'
        img.style.left = '-400px'
        img.style.bottom = 'calc(-50% + 460px)'
        img.style.zIndex = 999999
...
function nyancat () {
    ...
    let nyancat = function () {
        ...
        img.style.position = 'fixed'
        img.style.left = '-400px'
        img.style.bottom = 'calc(-50% + 540px)'
        img.style.zIndex = 999999
...
function salamander () {
    ...
    var salamander = function() {
        ...
        img.style.position = 'fixed';
        img.style.right = '-374px';
        img.style.bottom = 'calc(-50% + 440px)';
        img.style.zIndex = 999999;
...
function fox () {
    ...
    var fox = function() {
        ...
        img.style.bottom = 'calc(-50% + 390px)';
        img.style.zIndex = 999999;
